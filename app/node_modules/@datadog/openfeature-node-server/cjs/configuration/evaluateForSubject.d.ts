...
export declare function evaluateForSubject<T extends FlagValueType>(flag: Flag, type: T, subjectKey: string | null | undefined, subjectAttributes: EvaluationContext, defaultValue: FlagTypeToValue<T>, logger: Logger): ResolutionDetails<FlagTypeToValue<T>>;
